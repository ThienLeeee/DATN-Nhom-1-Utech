export default function ChiTietSanPham() {
  ...
  <div className="wrap-main wrap-page">
        ...
        <div className="top_detail">
          <div className="img_detail">
            <div className="main_img_detail">
              <a
                id="Zoomer"
                href="upload/product/v5i3465w11-4093.jpg"
              ...
              >
                <figure className="mz-figure mz-hover-zoom mz-ready">
                  <img
                    itemProp="image"
                    src="img/mainbalo.jpg"
                    alt="Laptop Dell Vostro 3530 V5I3465W1"
                    style={{ maxWidth: 378, maxHeight: 330 }}
                  />
                  <div
                    className="mz-lens"
                    style={{
                  ...
                  >
                    <img
                      src="https://stcom.vn/thumb/378x330/2/upload/product/v5i3465w11-4093.jpg"
                      style={{
                        position: "absolute",
                        top: 0,
                        left: 0,
                  ...
                  <div className="owl-wrapper-outer">
                    ...
                    >
                      <div className="owl-item" style={{ width: 95 }}>
                        <div className="item_owl_sub">
                          <a
                            href="upload/product/v5i3465w11-4093.jpg"
                            rel="zoom-id: Zoomer"
                            rev="thumb/378x330/2/upload/product/v5i3465w11-4093.jpg"
                            className="mz-thumb-selected mz-thumb"
                          >
                            <img
                              src="thumb/100x92/1/upload/product/v5i3465w11-4093.jpg"
                              className="w100"
                              alt="Laptop Dell Vostro 3530 V5I3465W1"
                            />
                          </a>
                      ...
                      <div className="owl-item" style={{ width: 95 }}>
                        <div className="item_owl_sub">
                          <a
                            href="upload/product/v5i3465w12-1929.jpg"
                            rel="zoom-id: Zoomer"
                            rev="thumb/378x330/2/upload/product/v5i3465w12-1929.jpg"
                            className="mz-thumb"
                          >
                            <img
                              src="img/child balo1.png"
                              className="w100"
                              alt="Laptop Dell Vostro 3530 V5I3465W1"
                            />
                          </a>
                      ...
                      <div className="owl-item" style={{ width: 95 }}>
                        <div className="item_owl_sub">
                          <a
                            href="upload/product/v5i3465w13-4412.jpg"
                            rel="zoom-id: Zoomer"
                            rev="thumb/378x330/2/upload/product/v5i3465w13-4412.jpg"
                            className="mz-thumb"
                          >
                            <img
                              src="img/child balo2.jpg"
                              className="w100"
                              alt="Laptop Dell Vostro 3530 V5I3465W1"
                            />
                          </a>
                      ...
                      <div className="owl-item" style={{ width: 95 }}>
                        <div className="item_owl_sub">
                          <a
                            href="upload/product/v5i3465w14-9063.jpg"
                            rel="zoom-id: Zoomer"
                            rev="thumb/378x330/2/upload/product/v5i3465w14-9063.jpg"
                            className="mz-thumb"
                          >
                            <img
                              src="img/child balo3.jpg"
                              className="w100"
                              alt="Laptop Dell Vostro 3530 V5I3465W1"
                            />
                          </a>
                      ...
                      <div className="owl-item" style={{ width: 95 }}>
                        <div className="item_owl_sub">
                          <a
                            href="upload/product/v5i3465w15-9046.jpg"
                            rel="zoom-id: Zoomer"
                            rev="thumb/378x330/2/upload/product/v5i3465w15-9046.jpg"
                            className="mz-thumb"
                          >
                            <img
                              src="img/child balo4.JPG"
                              className="w100"
                              alt="Laptop Dell Vostro 3530 V5I3465W1"
                            />
                          </a>
                      ...
                      <div className="owl-item" style={{ width: 95 }}>
                        <div className="item_owl_sub">
                          <a
                            href="upload/product/v5i3465w16-3498.jpg"
                            rel="zoom-id: Zoomer"
                            rev="thumb/378x330/2/upload/product/v5i3465w16-3498.jpg"
                            className="mz-thumb"
                          >
                            <img
                              src="thumb/100x92/1/upload/product/v5i3465w16-3498.jpg"
                              className="w100"
                              alt="Laptop Dell Vostro 3530 V5I3465W1"
                            />
                          </a>
                      ...
                      <div className="owl-item" style={{ width: 95 }}>
                        <div className="item_owl_sub">
                          <a
                            href="upload/product/v5i3465w17-2539.jpg"
                            rel="zoom-id: Zoomer"
                            rev="thumb/378x330/2/upload/product/v5i3465w17-2539.jpg"
                            className="mz-thumb"
                          >
                            <img
                              src="thumb/100x92/1/upload/product/v5i3465w17-2539.jpg"
                              className="w100"
                              alt="Laptop Dell Vostro 3530 V5I3465W1"
                            />
                          </a>
    ...
    <p>Tư vấn bán hàng Online</p>
                <div class="item_tuvan"><i class="fa fa-skype text-15 text-blue"></i>Mrs Bích: 0902 566 839</div>
                <div class="item_tuvan"><i class="fa fa-skype text-15 text-blue"></i>Mr Hải: 0903 359 388</div>
                <div class="item_tuvan"><i class="fa fa-skype text-15 text-blue"></i>Ms Thanh Tuyền: 0932 333 667</div>
              <div class="clear"></div>
  </div>
   */}
          </div>
          <div className="info_detail">
            ...
            <a href="tra-gop.html" className="btntragop" />
            <div className="item_info_detail masp">
              <strong>
                Mã SP : <span itemProp="mpn">V5I3465W1</span>
              </strong>
              <strong>
                Tình trạng :<span style={{ color: "#006fd5" }}>Còn hàng</span>
              </strong>
            </div>
            ...
            >
              <strong>
                ...
                <span itemProp="price" content={11990000}>
                  11.990.000
                </span>
                  ...
                  >
                    <tbody style={{ boxSizing: "border-box" }}>
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          <div
                            style={{ boxSizing: "border-box", lineHeight: 28 }}
                          >
                            <strong
                              style={{
                                boxSizing: "border-box",
                      ...
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          ...
                          >
                            ...
                            P-Cores: 1 Cores, 2 Threads, 1.60GHz Base, 4.50GHz
                            Turbo
                            <br style={{ boxSizing: "border-box" }} />
                            E-Cores: 4 Cores, 4 Threads, 1.30GHz Base, 3.30GHz
                            Turbo
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          ...
                          >
                            ...
                            Anti-Glare LED Backlit Narrow Border&nbsp;Non-Touch
                          </div>
                        </td>
                      </tr>
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                      ...
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span style={{ color: "#000000" }}>Bộ xử lý</span>
                            </span>
                          </div>
                        </td>
                        <td
                      ...
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          ...
                          >
                            ...
                            <br style={{ boxSizing: "border-box" }} />
                            1 x USB 2.0 port
                            <br style={{ boxSizing: "border-box" }} />1 x USB
                            3.2 Gen 1 Type-C
                            <sup style={{ boxSizing: "border-box" }}>®</sup>
                            &nbsp;port&nbsp;
                            <span
                      ...
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span style={{ color: "#000000" }}>Tai nghe</span>
                            </span>
                          </div>
                        </td>
                        <td
                      ...
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span style={{ color: "#000000" }}>Màu sắc</span>
                            </span>
                          </p>
                        </td>
                        <td
                      ...
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          ...
                          >
                            1. Chiều cao: 18,62 mm – 19,48 mm (0,73 inch – 0,77
                            inch)
                            <br style={{ boxSizing: "border-box" }} />
                      ...
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span style={{ color: "#000000" }}>Bảo mật</span>
                            </span>
                          </p>
                        </td>
                        <td
                      ...
                      <tr style={{ boxSizing: "border-box", height: 17 }}>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span style={{ color: "#000000" }}>Xuất xứ</span>
                            </span>
                          </p>
                        </td>
                        <td
              ...
              <div id="binhluan" className="content_tab active">
                <div className="text">
                  <div
                    ...
                    fb-iframe-plugin-query="app_id=&container_width=868&height=100&href=https%3A%2F%2Fstcom.vn%2Fsan-pham%2Flaptop-dell-vostro-3530-v5i3465w1-7385.html&locale=vi_VN&numposts=5&sdk=joey&version=v2.3&width="
                  >
                    <span
                      style={{
                        verticalAlign: "bottom",
