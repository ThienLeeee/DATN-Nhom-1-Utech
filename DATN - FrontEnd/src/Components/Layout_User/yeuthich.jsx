...
const Yeuthich = () => {
    ...
    const removeFromWishlist = async (productId) => {
        try {
            const response = await axios.delete('http://localhost:3000/api/wishlist/remove', {
                data: {
            ...
            if (error.response) {
                if (error.response.status === 404) {
                    toast.warning(
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            ...
                            <span style={{ flex: 1 }}>{error.response.data.message}</span>
                        </div>,
                        {
                            position: "top-right",
                            autoClose: 3000,
                    ...
                    toast.error(
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            ...
                            <span style={{ flex: 1 }}>Có lỗi xảy ra khi xóa sản phẩm khỏi danh sách yêu thích</span>
                        </div>,
                        {
                            position: "top-right",
                            autoClose: 3000,
                ...
                toast.error(
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <i className="fas fa-times-circle" style={{ fontSize: '24px' }}></i>
                        <span style={{ flex: 1 }}>Không thể kết nối đến server</span>
                    </div>,
                    {
                        position: "top-right",
                        autoClose: 3000,
